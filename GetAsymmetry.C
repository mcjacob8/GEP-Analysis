// ******************************************************************************** //
//                    Created by J.McMurtry on August 12th, 2025                    //
//                                                                                  //
//              Script to extract azimuthal distribution and asymmetry              //
// ******************************************************************************** //
...
// **** ========== Main functions ========== **** 
void GetAsymmetry( const char *configfilename, const char *chargefile="runCharge.txt", const char *outfilename="output/Asymmetry.root"){
  ...
  TH1D *hsclose = new TH1D("hsclose", "Distance of CLosest Approach", bins, 0.0, 0.015);
  TH1D *hzclose = new TH1D("hzclose", "z of Closest Approach", bins, 0.0, 3.0);
  TH1D *hzclose0 = new TH1D("hzclose0", "z of Closest Approach", bins, 0.0, 3.0);
  TH1D *hzclose1 = new TH1D("hzclose1", "z of Closest Approach", bins, 0.0, 3.0);
  TH1D *httheta = new TH1D("httheta", "Polar Scattering Angle", bins, 0.0, 30.0);
  TH2D *hzvtheta = new TH2D("hzvtheta", "z vs theta ; theta (deg); zclose (m)", bins, 0.0, 30.0, bins, 0.0, 3.0);
